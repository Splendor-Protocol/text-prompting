## Mistral7b LM  (BTLM) Miner
Bittensor LM 7B Language Model
This code is for running the very small (but poweful!) Bittensor Language Model created by mistal7b.  
